...
const generateUserTable = (request, response) => {
    ...
    let sql = format('CREATE TABLE %I (reqid INT, req_sent BOOL, date DATE, receiverid INT, amount NUMERIC(4, 2), paid BOOL, title VARCHAR, eventdate VARCHAR )', "user".concat(userid));
